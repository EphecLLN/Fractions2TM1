...
public class Fraction {
	...
	/**
	 * If the denominator is different from zero, the fraction is changed. After the
	 * operation, the fraction is reduced. Nothing is done in case of nul
	 * denominator for now : this will have to be change in the future
	 * 
	...
	/**
	 * Convert the fraction to its reduced form. In case of a negative fraction, the
	 * numerator must be positive and the denominator must be negative.
	 */
	private void reduce() {
	...
	/**
	 * Get a textual representation of the fraction Ex : 3, 1/2, 4/3
	 */
	...
	/**
	 * Represents the fraction as a mixed number, i.e. the sum of a integer and a
	 * proper fraction. Ex : 1 + 1/2 Ex : 2/3
	 * 
	 ...
	 * @return a new fraction which is the sum of f and the current fraction, in its
	 *         reduced form.
	 */
	 ...
	 * 
	 * @param f a non null fraction
	 * @return a new fraction which is the difference of f and the current fraction,
	 *         in its reduced form.
	 */
	 ...
	 * 
	 * @param f a non null fraction
	 * @return a new fraction which is the product of f and the current fraction, in
	 *         its reduced form.
	 */
	 ...
	 * 
	 * @param f a non null fraction
	 * @return a new fraction which is the division of f and the current fraction,
	 *         in its reduced form.
	 */
	...
	/**
	 * Computes the value of the current fraction raised to the given power. Current
	 * fraction is unmodified.
	 * 
	 * @param power the power to which the fraction is raised
	 * @return a new fraction equals to the current fraction raised to the given
	 *         power.
	 */
	 ...
	 *         a negative number if the current fraction is strictly less than f, 0
	 *         otherwise.
	 */
	...
	/**
	 * @return true if the current fraction is a unit fraction, i.e. its numerator
	 *         is 1 in its reduced form
	 */
	...
	/**
	 * 
	 * @return true if the fraction is proper, i.e. its absolute value is strictly
	 *         less than 1
	 */
	 ...
	 * @return true if the absolute value of the difference between f and the
	 *         current fraction is a unit fraction
	 */
